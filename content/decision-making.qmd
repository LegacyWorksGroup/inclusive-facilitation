---
title: "Supporting Group Decision Making"
---

This session is designed to help you support a team or collaborative group in working together to reach a decision. We will introduce the diamond model of participatory decision making as a framework for group process design and facilitation. You will learn to recognize the stages of participatory decision making and the type of thinking (divergent, emergent, or convergent) required for each stage. We will identify potential obstacles in each stage and practice tools and techniques to support innovative thinking, integration, and convergence / decision making. We’ll discuss the importance of clarity about how a decision will be made and by whom and explore how to select the appropriate decision making model for a given context.
...
- [{{< fa wand-magic-sparkles >}} Distributed leadership]{.cc-skill}
- [{{< fa wand-magic-sparkles >}} Systems thinking & synthesis]{.cc-skill}
...
Every facilitated process will reach a point where the group needs to make a decision, even if it's just whether to break for lunch. This module aims to equip you with the tools to support the group in making those decisions skillfully. We'll also learn to recognize when a group decision making process is worth the time and effort and when the group would be better served by a single decisionmaker making the call.

Sam Kaner's diamond model provides a fundamental framework for understanding and facilitating participatory decisionmaking (Kaner et al. 2014). It starts with problem definition and then moves through three phases, each characterized by a different style of thinking - divergent, emergent, and convergent. The diamond culminates with a solution to the problem - a decision. In this module we offer techniques to support each of those stages and ensure that ultimately, your group reaches that decision. 

<p align="center">
<img src="images/groan-zone.jpg" alt="Figure of Sam Kaner's Diamond Model of Participatory Decisionmaking, showing an increasing diversity of ideas on the left side of the diamond, created through divergent thinking, a period of emergent thinking in the middle known as the _groan zone_ and a narrowing set of ideas filtered down through convergent thinking to a final solution on the right side of the diamond." width="100%"/> 
...
Before we dive into the diamond model, let's distinguish four different forms of discourse and how they play into participatory decisionmaking. **Dialogue** is a collaborative effort to understand and learn from each other. **Debate**, on the other hand, is an oppositional effort to convince the other side that you are right. **Skillful discussion** has informed, objective decisions as its goal. **Polite discussion**, by contrast, often masks the fact that decisions are being made based on relationships and feelings rather than evidence. See the tabs below for more on how these styles differ.
...
Your role as a facilitator is to support inclusive dialogue and skillful discussion. When wrestling with complex topics, dialogue allows groups to recognize the limits on their own and others' individual perspectives and to strive for more comprehensive and coherent understanding. Dialogue becomes a container for collective thinking and exploration (especially during divergent and emergent thinking stages) - a process that can take teams in directions not imagined or planned. In dialogue, all views are treated as equally valid, and different views are presented as a means toward discovering a new view. Participants listen to understand one another and make shared meaning, not to win. 

When it comes time to make a decision, skillful discussion is required. This stage calls on us to be adept at giving and receiving feedback - separating people from their positions, speaking candidly, listening actively, and not taking criticism personally. As a facilitator, you can further support skillful discussion by addressing power dynamics and biases that might affect the group's ability to make an objective decision. Be conscious of hierarchies that might affect how people participate and the weight given to their views (see [Power Dynamics](https://legacyworksgroup.github.io/inclusive-facilitation/content/belonging.html#power-dynamics)). 

Both skillful discussion and dialogue are critical to the collaborative process, and the more artfully a group can move between these two forms of discourse (and out of less productive debate and polite discussion) according to what is needed, the more effective the group will be.

## Active Listening

Cultivating the presence and skills to be a good active listener will support your facilitation throughout all stages of group decision making. Active listening is listening to understand, rather than react. Try these active listening practices:

1. Be fully present
1. Use positive body language and nonverbal cues
1. Avoid interrupting or judging
1. Paraphrase or mirror back to check your understanding
1. Ask clarifying and/or open-ended questions
1. Validate where they are coming from / how they are feeling
1. Don’t give advice unless asked
1. Summarize main themes, ideas, or action items


## Embracing Divergent Thinking

The first stage of group decision making is divergent thinking (Kaner et al. 2014). Confronted with a new, complex topic, the group will gradually move from the safe territory of familiar opinions into sharing their diverse perspectives and exploring new ideas. This can feel like the group process is devolving away from what was assumed to be shared agreement about purpose or direction, but it is actually a critical part of the collaborative process.

When a diverse group comes together to work on a complex problem, their views are likely to diverge widely across many dimensions from problem definition to priorities to approaches to the definition of success. But you can tap that divergent thinking to generate entirely new ideas and options that emerge through the group's productive struggle for mutual understanding.

While your group is in the divergent thinking stage, it's critical to foster dialogue to surface different perspectives. Guard against  [action bias](https://en.wikipedia.org/wiki/Action_bias) which can lead to impatience with deliberation and hasty decisionmaking. Encourage disagreement and questioning. Examine hidden assumptions. Amplify diverse perspectives--and particularly, voices from the edge (e.g., junior members, new collaborators, people from different backgrounds, community members and other people who may be affected by the project)--in order to expand the range of possibilities. Mirror and validate what you hear. Invite people who are good at bridging perspectives to help translate and build shared understanding across different ways of thinking. Suspend judgment and encourage full participation. 

Beware of the most common pitfall at this stage, which is to converge too quickly on an early conclusion, staying in the safe space of familiar opinions and status quo solutions. You can prepare for this stage and help to avoid that pitfall by reviewing prior work, seeking input from different perspectives (e.g., through interviews, surveys, focus groups, guest speakers, or field trips), and synthesizing information and knowledge gaps, promising approaches, and critical questions. Your team can use that synthesis of the current situation as a jumping off point.

## Making it Through the Groan Zone

It's natural for groups to go through a period of confusion and frustration as they struggle to integrate their different perspectives into a shared framework of understanding (Kaner et al. 2014). The goal is to get the group across this no man's land between divergent thinking and convergence known as the ["groan zone"](https://i2insights.org/2019/05/28/collaboration-groan-zone/). In the groan zone, the group leader or facilitator's job is to keep the group from getting frustrated and shutting down.  
...
- Active listening
- Building shared understanding via translation (e.g. across different ways of knowing), metacognition (thinking about how you are thinking), and inquiry 
- Exploring new information, models, and ways of presenting information
...
- Examining how proposed ideas might affect each individual or organization in the group
...
- Differences in training, background, and vocabulary that impede understanding
...
- Inviting constructive opposition - ask the critic to say what they can support about a given proposal and what they would like to see changed or discussed further (see [Reading the Room](https://legacyworksgroup.github.io/inclusive-facilitation/content/meetings.html#reading-the-room) for more tips)
- Switching the participation format (e.g., going to breakout groups, brainstorming, a go-around, or individual writing)
- Taking a break
- Stepping out of the content and addressing the process (i.e., making a [bystand move](https://legacyworksgroup.github.io/inclusive-facilitation/content/meetings.html#reading-the-room))
...
Once the group has a strong foundation of shared understanding, things often start to click into place and feel easier and faster as you enter the zone of convergent thinking. At this point, the group is ready to devise inclusive solutions, weigh alternatives and make decisions. As the group leader your role is to help the group craft specific proposals, evaluate and decide among them, refine and synthesize into an overall approach, and lay out a concrete plan. The risk at this stage is that the group never converges on a clear decision or plan, leading the group to spin its wheels in the future.

Discuss as a team _who_ is ultimately responsible for making the decision and _how_ will the group be engaged - what is your decision making process going to be? Will it be based on consensus? Majority rules? Or will you delegate the decisionmaking to the team leader or a sub-team who are closest to the decision? What's your fallback plan if you can't reach a decision during your time together? The figure below arrays a variety of different decisionmaking processes onto the axes of level of group member involvement and level of group member ownership. Note that the two red circles that are off the graph in the bottom left should definitely be avoided! 

<p align="center">
<img src="images/decision-making.png" alt="Diagram of different decisionmaking models arrayed on two axes - level of involvement and level of ownership. Options include (in increasing order): Decide and announce; Gather input from individuals and decide; Gather input from group and decide; Vote (democratic or supermajority; Consensus; and Delegate with Constraints. Both voting and delegating with constraints are fallback options if consensus can't be reached." width="100%"/> 
<figcaption> **Decision making approaches and fallback options**</figcaption>
</p>

Pick your decision model to suit your context. Consensus and other participatory decision making processes take time and effort and shouldn't be used for every decision. Small decisions, low risk decisions, and those that sit squarely within one person's authority don't need to be made by consensus. For bigger decisions, consider, what's more important - speed or group ownership? Which will be more costly to your group: a missed opportunity that results from moving too slowly or an uninformed / bad decision? Is this decision a one-way door or is it easily reversible? Is the proposal safe to try? If moving quickly is valuable and the proposal constitutes a safe-to-try experiment that won't jeopardize your mission, you may want to empower an individual or team to make the decision and act.

### Consent Process

Consider a consent decision making process to reach safe-to-try decisions with these rounds:

1. Offer proposal
1. Field clarifying questions
1. Invite and listen to reactions to the proposal
1. Restate proposal (with or without changes)
1. Listen to objections - “Do you see any reasons why adopting this proposal would cause harm or move us backward?”
1. Amend proposal to address objections
1. Ratify proposal if all objections have been addressed


### Decisionmaking checklist

- [ ] Clarify what is being decided: What's the question? What are the options?
- [ ] Set a realistic timeline for decisionmaking, then clearly communicate when it's time to end deliberation and make a decision (Fist to Five / Levels of agreement can help you assess if the group is ready)
- [ ] Identify the decisionmaker: Who ultimately has responsibility for making this decision?
- [ ] Identify your decision making model
    - Consensus - everyone agrees
    - Consent - no one objects
    - Majority rules
    - Delegate to an individual or group
- [ ] Check your [biases](https://thedecisionlab.com/biases-index) - Have you checked your assumptions? Have you sought diverse opinions? Have you adequately considered the downside risks?
- [ ] Know your fallback plan if you can’t reach your decision threshold within your allotted timeframe

### DARCI

A **DARCI** grid can clarify who is the decision maker and who will be affected by the decision.

| **Task** | **Decisionmaker** | **Accountable** | **Responsible** | **Consulted** | **Informed** |
|:---------------|:---------------|:---------------|:---------------|:---------------|:---------------|
| | These people have the ultimate and final approval or veto power | This single person is accountable for ensuring the work gets done | These are the people who are responsible for contributing to the work | Those from whom input will be solicited | Those to be kept apprised of relevant developments |
| Workstream 1 | Name | Name | Name | Name | Name |
| Workstream 2 | Name | Name | Name | Name | Name |
| | | | | | |

### Techniques to support convergence:

Convergent thinking requires critical analysis of alternative ideas and active listening. Useful techniques in this phase include:

- Define the decision clearly; frame the challenge while staying open to a range of possible solutions
- Invite concrete, written proposals
- Leave space for thinking and metabolism of ideas (reflection, movement, writing, or research time)
- State your selection criteria and get clear about how you will evaluate proposals against them (see feasibility-impact matrix)
- Assess levels of agreement (see Fist to Five)
- Combine the best elements of multiple ideas to support more innovative, inclusive solutions
- Before the final decision, narrow the pool of possible options to a manageable set (2-5)
- Decide what ideas to pursue and which to keep on the back burner in case the team needs to adapt
- Define next steps, assess capacity, and assign roles and responsibilities

While the big work of the initial stage of any project is getting to convergence on the overall work plan, you should expect that your team will go through the process of divergence and convergence many times as you dive into the work and uncover new challenges. But the shared understanding and social rapport that come from successfully struggling together early on will allow the group to more easily and rapidly develop and implement new solutions in subsequent meetings.
...
::: {.callout-note icon="false"}
### Small Group Exercise #1 - TBD

Purpose: {{< fa person-digging >}}

**Part 1 - Individual Reflection**


**Part 2 - Breakout Group **
...
| Turn and learn / chat waterfall | D | Avoid the [primacy effect](https://thedecisionlab.com/biases/primacy-effect) (the first idea getting the most attention and biasing what comes next) by having everyone write down their idea (or their understanding of a situation) and then post them simultaneously on the wall or in a chat |
...
| [Pre mortem](https://gamestorming.com/pre-mortem/) | DE | Share past learnings and assess risks early | At the start of a project, ask “What will go wrong?” or even “How will this end in disaster?” | Compile and rank the potential risks. Use the pre mortem as a jumping off point for further design discussions. |
...
| [3D Modeling](https://www.u-school.org/3dmodelling) from the Presencing Institute | E | Uncover hidden dynamics in systems and identify leverage points for change | Co-create a three dimensional model that maps a current situation or system (using small items such as figurines, feathers, pieces of wool, etc. to symbolize elements and dynamics). Reflect on the model, then reshape it to better reflect your preferred future system state. Provides a playful way in to difficult conversations. Add a gallery walk so folks can see each other's models |
...
| Polling | EC | Rank alternatives | Decide how many votes per person - a good rule of thumb is 1 dot for every 4 or 5 alternatives; In person - use sticky dots; Virtually - use +1s in a google doc or a digital polling tool (e.g., Zoom, Mural, slido) | Before you start - clarify how you will use the results - are you gauging the distribution of support (a heat map) or taking a vote to make a decision? |
...
::: {.callout-note icon="false"}
#### Activity: Small Group Exercise #2 - TBD {{< fa person-digging >}}

**Part 1 - Breakout Group**
...
- [The Decision Lab: Biases](https://thedecisionlab.com/biases-index)
