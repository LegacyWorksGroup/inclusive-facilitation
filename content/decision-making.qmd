...
This session is designed to help participants support the kind of thinking their groups need to move forward to an effective decision. We will introduce the diamond model of participatory decision making as a framework for group process design. We will learn to recognize the stages of participatory decision making and the type of thinking (divergent, emergent, or convergent) required for each stage. Participants will learn to recognize potential obstacles in each stage and practice tools and techniques to support innovative thinking, integration, and convergence / decision making. We’ll discuss the importance of clarity about how a decision will be made and by whom and explore how to select the appropriate decision making model for a given context.
...
:::
## Under Construction
{{< person-digging >}} This site is under construction. Check back soon for updates. 
