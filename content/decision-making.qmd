...
- Clearly communicate when it's time to end deliberation and make a decision
...
- Know your fallback plan if you can’t reach your decision threshold
...
|:---------------|:---------------|:---------------|:---------------|:---------------|:---------------|
| | These people have the ultimate and final approval or veto for project-related decisions | This single person is accountable for ensuring the work gets done | These are the people who are responsible for doing work on the project | Those from whom input will be solicited | Those to be kept apprised of relevant developments |
