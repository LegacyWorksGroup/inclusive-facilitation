...
This session will offer best practices for in person and virtual meeting design. We will demonstrate a set of “[Liberating Structures](https://www.liberatingstructures.com/ls/)” for engaging, effective group meetings. We will practice active listening skills essential to effective facilitation. And we will practice using David Kantor’s Four-Player Model as a way to “read the room” and diagnose and shift group dynamics.
...
- Reflect silently on the following questions and provide input via the anonymous poll
    - What's one thing you and your team or collaborative group are doing really well to ensure effective meetings?
    - What's one area where you would like to improve your facilitation or meeting design skills? What do you find challenging?
...
- One partner takes note while the other describes the meeting they want to focus on, then switch roles
- Plan your next meeting together (resources: EasyRetro board, tools highlighted above)
    ...
    - _What activities will you use to make your meeting inclusive?_
