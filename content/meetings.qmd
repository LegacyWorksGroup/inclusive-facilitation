...
::: {.callout-note icon="false"}
#### Activity: Defining Your Purpose for Meeting

**Part 1**

On your own, think about an upcoming meeting that hasn't yet been planned

- _Why will you be meeting? What is the purpose of the meeting?_ 
...
| **<span style="color:red">Failure</span>** | **<span style="color:orange">Minimum / Essential Success</span>** | **<span style="color:green">Target Success</span>** | **<span style="color:#006400">Epic Success</span>** |
|:----------|:----------|:------------|:----------------|
...
::: {.callout-note icon="false"}
#### Activity: Exploring Liberating Structures

On your own:

- Open the [Liberating Structures Matchmaker](https://drive.google.com/file/d/1NZy2MxvXuD86m1PxxbQsvKVbP53HXPYz/view?usp=drive_link)
- Select a purpose from the matchmaker that matches with something you are trying to achieve in your meeting
- Go to the [Liberating Structures website](https://www.liberatingstructures.com/ls-menu/) and read about the corresponding microstructure
- Imagine a scenario where you might use it
- How would it help support your purpose?

:::

::: {.callout-warning icon="false"}
#### Discussion: Meeting Microstructures

- What activity(ies) did you identify that might help you engage your meeting participants and achieve your purpose?
...
Each action in a group conversation can be coded into one of these four action modes. 
...
#### Activity: Experiencing the Four Player Actions

**Part 1**

In groups of four:

- Assign a timekeeper - you’re going to switch roles every 3 minutes
- Pick a role - Move, Follow, Oppose, or Bystand
- Discuss: What would it look like for this group to become a true community of practice? How could we help that to develop?
- When the first three minutes is up, rotate roles clockwise. Move > Follow, Follow > Oppose, Oppose > Bystand, Bystand > Move.
- Continue the conversation using your new roles.
- Rotate again every 3 mins. 

:::

::: {.callout-warning icon="false"}
#### Discussion: Debriefing the Four Player Experience

- How was that experience? 
- Was one role more comfortable than others?
- Is that the role you often find yourself playing? Does that change depending up on the setting?

:::

Most of us have one of these modes that we feel most comfortable in and tend to default to in a group. The most effective conversations involve good listening and the skillful use of **all four modes**. Common "stuck" patterns emerge when groups are not deploying all four actions.
...
### Practice the Four Player Model 

Three ways you can practice:

- **Reflective Replay:** Think of a recent challenging team meeting. Map out who played which role. Identify which role was missing.
- **Role-Play Scenario:** Have a team discuss a hypothetical problem, but assign members to deliberately play only one of the four roles, then rotate.
- **Active Observation:** During a live meeting that you aren’t facilitating, take notes on the Four-Player roles being used. Optionally, share your observations with the group.
